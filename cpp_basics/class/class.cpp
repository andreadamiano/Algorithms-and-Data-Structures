...
//     public:
//         Counter() // constructor (initialize the counter to 0, no return type)
//         {
//             count = 0;
//         }
//         int get_counter()
...
//             freqFlyerNo = "None";
//         }
//         Passenger(const std::string& nm, bool isFF, const std::string& ffn = "None") // constructor with default argument
//         {
//             name = nm;
//             isFreqFlyer = isFF;
//             freqFlyerNo = ffn;
